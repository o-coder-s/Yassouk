...
<div class="col-12 col-lg-11 mt-5 mx-auto">
    <form action="">
        <div class="row">
            ...
            <div class=" col-4 col-lg-2 text-right">
                <a href="<?php echo URLROOT ?>/gestion/aUtilisateur/2" class="btn btn-primary w-100 text-light"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button data-dismiss="modal" class="cancel btn btn-secondary">ANNULER</button>
    ...
    <script type="text/javascript">
        ...
        function getCandidats(){
            $.ajax({
                type: 'POST',
                url: "<?php echo URLROOT; ?>/gestion/candidats",
